...
alter table "public"."line_items" add constraint "line_items_product_id_fkey" FOREIGN KEY (product_id) REFERENCES products(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."line_items" validate constraint "line_items_product_id_fkey";

alter table "public"."line_items" add constraint "line_items_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON UPDATE CASCADE not valid;
